function [ret, filterInfo] = OPX_GetContSourceChanFilterInfoByName(h, sourceName, sourceChan)

% OPX_GetContSourceChanFilterInfoByName: Returns the filter information
...
[ret, filterInfo] = mexOPXClient(46, h, sourceName, sourceChan);
