function [ret, filterInfo] = OPX_GetContSourceChanFilterInfoByNumber(h, sourceNum, sourceChan)
...
% - sourceNum: string containing the source's name, e.g. "FP"
...
[ret, filterInfo] = mexOPXClient(45, h, sourceNum, sourceChan);
