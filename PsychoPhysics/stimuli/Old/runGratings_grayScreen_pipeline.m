function runGratings_grayScreen_func_screen(params,angle, cyclespersecond, freq, gratingsize, internalRotation)
...
%[win, rect] = PsychImaging('OpenWindow', params.screenNumber, params.gray);

%fix gamma (it will be applied on next screen flip)
%PsychColorCorrection('SetEncodingGamma',win,1/params.gamma);
