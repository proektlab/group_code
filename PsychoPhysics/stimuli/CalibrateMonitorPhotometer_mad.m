function [ gammaTable1, gammaTable2, displayBaseline, displayRange, displayGamma, maxLevel ] = CalibrateMonitorPhotometer_mad(numMeasures, screenid)
...
global inputV;
    ...
    try
       ...
       % LoadIdentityClut(win);
         load gamma_calib_danphotometer.mat gammaTable2
