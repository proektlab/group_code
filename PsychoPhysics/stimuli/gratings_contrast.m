...
function gratings_contrast(params,xcenter,ycenter,texsize,contrast_test,sf,tf)
try
    if exist('params')
    ...
    movieDurationSecs=2.1; % Abort demo after 60 seconds.
    ...
    Screen('DrawTexture', params.window, gratingtex1, srcRect, dstRect, angle, [], [0], [], [], [], [0, yoffset, 0, 0]);
    vbl = Screen('Flip', params.window, vbl + (waitframes - 7/8) * ifi);
