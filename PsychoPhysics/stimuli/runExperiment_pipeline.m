...
save([params.mouseID,'_',params.TrackID,'_test_params.mat'],'texsize','contrasts_mask', 'test_con', 'xcenter', 'ycenter', 'sf', 'tf');


% %run the full plaid program
...
params.RFpixelDeg=4; %x degrees per RF pixel (RF pixels are different than larger monitor pixels!)
fullScreen_flag=0;
%now get RF 
numBlocks=2;
