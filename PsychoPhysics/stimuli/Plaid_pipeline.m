...
function Plaid_pipeline(xcenter,ycenter,texsize,contrast_test,contrast_mask,sf,tf)
try
    if exist('params')
    ...
    movieDurationSecs=4.1; % Abort demo after 60 seconds.
    
    Datapixx('SetDoutValues', [0]);
    Datapixx('RegWrRd');
    
    order=randperm(3); %randomize presentation of test, mask, and test+mask for this particular set of contrasts
    for i=1:3
    switch (order(i))
        case 1
