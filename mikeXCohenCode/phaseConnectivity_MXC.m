...
phase_angle_differences = phase_data(2,:)-phase_data(1,:); %subtract wave angles in radians and not the complex values 

% euler representation of angles
euler_phase_differences = exp(1i*phase_angle_differences); %euilierize phase angle diff

% mean vector (in complex space)
mean_complex_vector = mean(euler_phase_differences);%mean 
