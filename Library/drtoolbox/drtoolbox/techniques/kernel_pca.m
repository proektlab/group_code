function [mappedX, mapping] = kernel_pca_(X, no_dims, varargin)
%KERNEL_PCA Perform the kernel PCA algorithm
%
%   [mappedX, mapping] = kernel_pca_(X, no_dims)
%   [mappedX, mapping] = kernel_pca_(X, no_dims, kernel)
%   [mappedX, mapping] = kernel_pca_(X, no_dims, kernel, param1)
%   [mappedX, mapping] = kernel_pca_(X, no_dims, kernel, param1, param2)
%
